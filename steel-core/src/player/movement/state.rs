...
impl MovementState {
    ...
    pub(in crate::player) const fn set_last_client_input(&mut self, input: PlayerInput) {
        self.last_client_input = input;
    }

    /// Returns the latest client input snapshot.
    #[must_use]
    pub(in crate::player) const fn last_client_input(&self) -> PlayerInput {
        self.last_client_input
    }

    /// Resets per-tick vanilla movement validation bases.
    pub(in crate::player) const fn reset_for_tick(&mut self, position: DVec3) {
        self.client_movement.reset_for_tick(position);
    }

    /// Resets per-tick vanilla controlled-vehicle movement validation bases.
    pub(in crate::player) const fn reset_vehicle_for_tick(
        &mut self,
        vehicle_id: i32,
        position: DVec3,
    ) {
    ...
    pub(in crate::player) const fn clear_vehicle_for_tick(&mut self) {
    ...
    #[must_use]
    pub(in crate::player) const fn vehicle_good_positions(
        &self,
        vehicle_id: i32,
    ) -> Option<(DVec3, DVec3)> {
    ...
    pub(in crate::player) const fn reset_for_position_sync(&mut self, position: DVec3) {
    ...
    pub(in crate::player) const fn record_move_packet_delta(&mut self) -> i32 {
    ...
    pub(in crate::player) const fn mark_vehicle_last_good_position(
        &mut self,
        vehicle_id: i32,
        position: DVec3,
    ) {
    ...
    pub(in crate::player) const fn reset_last_known_client_movement(&mut self) {
        self.client_movement.reset_last_known_client_movement();
        self.received_movement_this_tick = false;
    }

    /// Applies vanilla client-tick-end known-movement handling.
    pub(in crate::player) const fn finish_client_tick(&mut self) {
    ...
    #[must_use]
    pub(in crate::player) const fn last_known_client_movement(&self) -> DVec3 {
    ...
    pub(in crate::player) const fn record_client_floating(&mut self, client_is_floating: bool) {
        self.client_movement
    ...
    pub(in crate::player) const fn record_vehicle_client_floating(
        &mut self,
        vehicle_id: i32,
    ...
    pub(in crate::player) const fn reset_flying_ticks(&mut self) {
    ...
    pub(in crate::player) const fn tick_client_floating(
        &mut self,
        should_count: bool,
    ...
    ///
    /// Returns true once the client has exceeded the configured maximum flying ticks.
    pub(in crate::player) const fn tick_vehicle_client_floating(
        &mut self,
        vehicle_id: i32,
        maximum_flying_ticks: i32,
    ) -> bool {
